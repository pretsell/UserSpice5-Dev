	...
	<div class="col-xs-12"> <!-- Site Settings Column -->
		...
		<div class="form-group">
			...
			<select class="form-control" name="mail_method">
				<option value="smtp" <?php if($cfg->get('mail_method')=='smtp') echo 'selected="selected"'; ?> >SMTP Server</option>
				<option value="sendmail" <?php if($cfg->get('mail_method')=='sendmail') echo 'selected="selected"'; ?> >Sendmail</option>
				<option value="phpmail" <?php if($cfg->get('mail_method')=='phpmail') echo 'selected="selected"'; ?> >PHP Mail()</option>
			</select>
		</div>
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="smtp_server" id="smtp_server" value="<?=$cfg->get('smtp_server')?>">
		</div>

		<!-- smtp_port -->
		<div class="form-group">
			<label for="smtp_port">SMTP Port (only applies to SMTP method)</label>
			<input type="text" class="form-control" name="smtp_port" id="smtp_port" value="<?=$cfg->get('smtp_port')?>">
		</div>
		...
		<div class="form-group">
			...
			<select class="form-control" name="smtp_transport">
				<option value="tls" <?php if($cfg->get('smtp_transport')=='tls') echo 'selected="selected"'; ?> >TLS (encrypted)</option>
				<option value="ssl" <?php if($cfg->get('smtp_transport')=='ssl') echo 'selected="selected"'; ?> >SSL (encrypted, but weak)</option>
			</select>
		</div>
		...
		<div class="form-group">
			<label for="email_login">Email Login (only applies to SMTP method)</label>
					<input type="text" class="form-control" name="email_login" id="email_login" value="<?=$cfg->get('email_login')?>">
		</div>

		<!-- email_pass -->
		<div class="form-group">
			<label for="email_pass">Email Password (only applies to SMTP method)</label>
			<input type="text" class="form-control" name="email_pass" id="email_pass" value="<?=$cfg->get('email_pass')?>">
		</div>

		<!-- from_name -->
		<div class="form-group">
			<label for="from_name">From Name</label>
			<input type="text" class="form-control" name="from_name" id="from_name" value="<?=$cfg->get('from_name')?>">
		</div>

		<!-- from_email -->
		<div class="form-group">
			<label for="from_email">From Email</label>
			<input type="text" class="form-control" name="from_email" id="from_email" value="<?=$cfg->get('from_email')?>">
		</div>
