...
if (Input::exists()) {
	...
	if ($validation->passed()) {
		...
		if (!configGet('allow_username_change'))
...
?>
	...
	<form name='updateAccount' action='profile.php' method='post'>
		...
		<div class="form-group">
			...
			<input  class='form-control' type='text' name='username' value='<?=$username?>' <?php if (!configGet('allow_username_change')) echo "readonly"; ?>/>
		</div>
