...
class FormField {
	...
	public function __construct($label='New Field',$id='newfield',$elementAndType='input_text'){
		...
		$name = field name within the form
		...
		$validation = whether there is validation or not
	...
	public function setObjectWrapperClass($objectWrapperClass){
		$this->_objectWrapperClass = $objectWrapperClass;
	}

	public function setElementClass($elementClass){
		/*
		Need to have a space at the start of the $elementClass string so concatenation works
		*/
