...
$init_commands = [
    ...
    "CREATE TABLE `{$prefix}pages` (
          ...
          `after_create` tinyint(1) DEFAULT NULL,
          `after_edit` tinyint(1) DEFAULT NULL,
          `after_delete` tinyint(1) DEFAULT NULL,
    ...
    "INSERT INTO `{$prefix}pages` (`id`, `page`, `private`, `title_token`, `breadcrumb_parent_page_id`) VALUES
        ...
        (15, '{$US_PAGE_PATH}/password_reset.php', 0, 'PASSWORD_RESET_TITLE', NULL),
        (18, '{$US_PAGE_PATH}/join.php', 0, 'JOIN_TITLE', NULL),
        (20, '{$US_PAGE_PATH}/login.php', 0, 'LOGIN_TITLE', NULL),
        (21, '{$US_PAGE_PATH}/logout.php', 0, 'LOGOUT_TITLE', NULL),
        (22, '{$US_PAGE_PATH}/profile.php', 1, 'PROFILE_TITLE', NULL),
        (26, '{$US_PAGE_PATH}/verify_resend.php', 0, 'VERIFY_RESEND_TITLE', NULL),
        (30, '{$US_PAGE_PATH}/admin_email.php', 1, 'ADMIN_EMAIL_TITLE', 93),
        (32, '{$US_PAGE_PATH}/admin_settings.php', 1, 'ADMIN_SETTINGS_TITLE', 93),
        (33, '{$US_PAGE_PATH}/admin_email_test.php', 1, 'ADMIN_EMAIL_TEST_TITLE', 30),
        (36, '{$US_PAGE_PATH}/admin_page.php', 1, 'ADMIN_PAGE_TITLE', 93),
        (39, '{$US_PAGE_PATH}/admin_user.php', 1, 'ADMIN_USER_TITLE', 40),
        (40, '{$US_PAGE_PATH}/admin_users.php', 1, 'ADMIN_USERS_TITLE', 93),
        (43, '{$US_PAGE_PATH}/admin_menus.php', 0, 'ADMIN_MENUS_TITLE', 93),
        (44, '{$US_PAGE_PATH}/admin_menu.php', 0, 'ADMIN_MENU_TITLE', 43),
        (45, '{$US_PAGE_PATH}/admin_menu_item.php', 0, 'ADMIN_MENU_ITEM_TITLE', 44),
        (46, '{$US_PAGE_PATH}/admin_email_template.php', 1, 'ADMIN_EMAIL_TEMPLATE_TITLE', 93),
        (48, '{$US_PAGE_PATH}/index.php', 0, 'INDEX_TITLE', NULL),
        (49, '{$US_PAGE_PATH}/contact.php', 0, 'CONTACT_TITLE', NULL),
        (50, '{$US_PAGE_PATH}/gallery.php', 1, 'GALLERY_TITLE', NULL),
        (59, '{$US_PAGE_PATH}/admin_users_add.php', 1, 'ADMIN_USERS_ADD_TITLE', 40),
        (62, '{$US_PAGE_PATH}/blocked.php', 0, 'BLOCKED_TITLE', NULL),
        (66, '{$US_PAGE_PATH}/admin_updates.php', 1, 'ADMIN_UPDATES_TITLE', 93),
        (68, '{$US_PAGE_PATH}/admin_backup.php', 1, 'ADMIN_BACKUP_TITLE', 93),
        (69, '{$US_PAGE_PATH}/admin_restore.php', 1, 'ADMIN_RESTORE_TITLE', 93),
        (70, '{$US_PAGE_PATH}/admin_status.php', 1, 'ADMIN_STATUS_TITLE', 93),
        (71, '{$US_PAGE_PATH}/admin_phpinfo.php', 1, 'ADMIN_PHPINFO_TITLE', 93),
        (74, '{$US_PAGE_PATH}/admin_groups.php', 1, 'ADMIN_GROUPS_TITLE', 93),
        (80, '{$US_PAGE_PATH}/admin_group.php', 1, 'ADMIN_GROUP_TITLE', 74),
        (82, '{$US_PAGE_PATH}/oauth_denied.php', 0, 'OAUTH_DENIED_TITLE', NULL),
        (83, '{$US_PAGE_PATH}/admin_role.php', 1, 'ADMIN_ROLE_TITLE', 84),
        (84, '{$US_PAGE_PATH}/admin_roles.php', 1, 'ADMIN_ROLES_TITLE', 93),
        (85, '{$US_PAGE_PATH}/admin_grouptypes.php', 1, 'ADMIN_GROUPTYPES_TITLE', 93),
        (86, '{$US_PAGE_PATH}/admin_grouptype.php', 1, 'ADMIN_GROUPTYPE_TITLE', 85),
        (87, '{$US_PAGE_PATH}/nologin.php', 0, 'NOLOGIN_TITLE', NULL),
        (93, '{$US_PAGE_PATH}/admin.php', 1, 'ADMIN_TITLE', NULL),
        (94, '{$US_PAGE_PATH}/admin_general.php', 0, 'ADMIN_GENERAL_TITLE', 93),
        (95, '{$US_PAGE_PATH}/verify.php', 0, 'VERIFY_TITLE', NULL),
        (96, '{$US_PAGE_PATH}/admin_pages_old.php', 0, 'ADMIN_PAGES_OLD_TITLE', 93),
        (97, '{$US_PAGE_PATH}/admin_page_old.php', 0, 'ADMIN_PAGE_OLD_TITLE', 96)",
    ...
    "INSERT INTO `{$prefix}settings` (`id`, `site_name`, `site_url`,
            ...
            `forgot_password_template`, `redirect_login`, `redirect_logout`,
            `redirect_deny_nologin`, `redirect_deny_noperm`,
