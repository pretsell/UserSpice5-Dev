...
$permsSelect[0]='No Perms Required';
foreach ($permissions as $permission){
	$permsSelect[$permission->id]=$permission->name;
}
...
<div class="row">
	...
	<div class="table-responsive">
		<table class="table table-bordered table-hover table-condensed">
			<thead><tr><th>ID</th><th>Label</th><th>Parent</th><th>Link</th><th>Dropdown</th><th>Permission</th><th>Logged In</th><th>Display Order</th><th>Icon Class</th><th>Action</th></tr></thead>
			<tbody>
			<?php
			$i=0;
			...
			?>
				...
				<td><?=$permsSelect[$item->perm_level]?></td>
