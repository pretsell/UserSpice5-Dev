...
<div class="row"> <!-- rows for Main Settings -->
	<div class="col-xs-12"> <!-- Site Settings Column -->
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" name="site_name" id="site_name" value="<?=configGet('site_name')?>">
		</div>

		<!-- Site URL -->
		<div class="form-group">
			<label for="site_url">Site URL</label>
			<input type="text" class="form-control" name="site_url" id="site_url" value="<?=configGet('site_url')?>">
		</div>

		<!-- Install Location -->
		<div class="form-group">
			<label for="install_location">Install Location</label>
			<input type="text" class="form-control" name="install_location" id="install_location" value="<?=configGet('install_location')?>">
		</div>

		<!-- Copyright Message -->
		<div class="form-group">
			<label for="copyright_message">Copyright Message</label>
			<input type="text" class="form-control" name="copyright_message" id="copyright_message" value="<?=configGet('copyright_message')?>">
		</div>
		...
		<div class="form-group">
			...
			<select id="recaptcha" class="form-control" name="language">
				<option value="en" <?php if(configGet('language')=='en') echo 'selected="selected"'; ?> >en</option>
			</select>
		</div>
		...
		<div class="form-group">
			...
			<select id="site_offline" class="form-control" name="site_offline">
				<option value="1" <?php if(configGet('site_offline')==1) echo 'selected="selected"'; ?> >Yes</option>
				<option value="0" <?php if(configGet('site_offline')==0) echo 'selected="selected"'; ?> >No</option>
			</select>
		</div>
		...
		<div class="form-group">
			...
			<select id="debug_mode" class="form-control" name="debug_mode">
				<option value="1" <?php if(configGet('debug_mode')==1) echo 'selected="selected"'; ?> >Yes</option>
				<option value="0" <?php if(configGet('debug_mode')==0) echo 'selected="selected"'; ?> >No</option>
			</select>
		</div>
		...
		<div class="form-group">
			...
			<select id="track_guest" class="form-control" name="track_guest">
				<option value="1" <?php if(configGet('track_guest')==1) echo 'selected="selected"'; ?> >Yes</option>
				<option value="0" <?php if(configGet('track_guest')==0) echo 'selected="selected"'; ?> >No</option>
